...
var Sea = function(ampValue, vertX, vertY, waveOpacity,textOffsetX, textOffsetY) {
	...
	var textWaves = new THREE.TextureLoader().load( "img/water.png" );
...
function initSkybox(){
	...
	var urls = [
		'img/skybox/sky_pos_x.png',
		'img/skybox/sky_neg_x.png',
		'img/skybox/sky_pos_y.png',
		'img/skybox/sky_neg_y.png',
		'img/skybox/sky_neg_z.png',
		'img/skybox/sky_pos_z.png'
	];
...
var lowerSea, sea, seaBed, boat, desertIsland, seaGull;
